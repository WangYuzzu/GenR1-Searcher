                ...
                if len(retrieval_query_list) > 0:
                    ...
                    try:
                        ...
                        if response.status_code == 200:
                            ...
                            logger.warning(f"⚠️ 检索服务响应异常: {response.status_code}")
                ...
                if len(generation_query_list) > 0:
                    ...
                    try:
                        ...
                        if response.status_code == 200:
                            ...
                            logger.warning(f"⚠️ 文档生成服务响应异常: {response.status_code}")
...
#                     stop_reason = output.outputs[0].stop_reason
#                     generated_text = output.outputs[0].text
#                     print(f'此次生成的内容: {generated_text}')
#
#                     if "prompt_ids" not in continued_answer[q]:
#                         input_token_ids = list(output.prompt_token_ids)
#                     else:
...
#                         query = " ".join(query.split())
#                         if query: #开始检索
#                             print(f'提取到query: {query}')
#                             query_list.append(query)
#                             retrieve_num_count += 1
#                             print(f'此时检索次数: {retrieve_num_count}')
#                             original_data = {
#                                 "idx":idx,
#                                 "prompt":prompt + generated_text.strip(),
#                                 "prompt_ids":input_token_ids,
...
#                         print('生成结束')
#                         print(f'此时检索次数: {retrieve_num_count}')
#                         print(f'此时生成的文本: {generated_text}')
#                         original_data = {
#                         "idx":idx,
#                         "prompt_ids":input_token_ids,
#                         "response_ids":output_token_ids,
...
#                             end_tokens = [522, 91, 408, 3575, 75927, 91, 1339]
#                         else: #qwen
#                             start_tokens = [27, 91, 7265, 3575, 75927, 91, 397] #<|begin_of_documents|>\n
#                             end_tokens = [522, 91, 408, 3575, 75927, 91, 1339] #end_of_documents|>\n\n
#
#                         is_in_masking = False
#                         mask_start_idx = -1
#                         start_count = 0
...
#                             print(f"三者匹配: {[start_count,end_count,output['retrieve_num_count']]}")
#                             pass
#                         else:
